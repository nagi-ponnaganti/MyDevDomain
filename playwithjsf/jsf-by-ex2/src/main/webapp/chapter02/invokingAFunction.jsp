...
<html>
    <head>
        ...
        <title>Invoking a Function in an Expression</title>
    </head>
    <body>
        ...
        <jsp:useBean id="conditionalBean" scope="page" class="org.javaserverfaces.chapter02.ConditionalClass"/>
