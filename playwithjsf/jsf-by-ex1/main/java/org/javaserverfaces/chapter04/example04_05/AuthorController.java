...
public class AuthorController implements Serializable {
    ...
    private void populateAuthors(){
        Book book1 = new Book("Java 7 Recipes", "java7examples.png");
        Book book2 = new Book("Java EE 7 Recipes", "javaee7examples.png");
