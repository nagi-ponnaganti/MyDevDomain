        ...
        try {
            ...
            Configuration configuration =
                    new Configuration().addAnnotatedClass(com.nagihome.samplewebapp.temp.Product.class)
                            ...
                            .addAnnotatedClass(com.nagihome.samplewebapp.temp.Disc.class)
                            .addAnnotatedClass(com.nagihome.samplewebapp.temp.AudioDisc.class)
                            .addAnnotatedClass(com.nagihome.samplewebapp.temp.VideoDisc.class)
